#!/usr/bin/env bash
# Builds the standalone image-to-video runner for the current platform.
# Output: python/runners/image-to-video/dist/image-to-video-<os>-<arch>/image-to-video-<os>-<arch>[.exe]
# Environment:
...
name="image-to-video-$(../../platform.sh)"
