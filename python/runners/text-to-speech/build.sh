#!/usr/bin/env bash
# Builds the standalone text-to-speech runner for the current platform.
# Output: python/runners/text-to-speech/dist/text-to-speech-<os>-<arch>/text-to-speech-<os>-<arch>[.exe]
# Environment:
...
name="text-to-speech-$(../../platform.sh)"
