...
/**
 * Settings for generating videos, read from config/text-to-video.php.
 */
final class TextToVideoConfig
{
    public const DEFAULT_FILE = __DIR__ . '/../../config/text-to-video.php';
